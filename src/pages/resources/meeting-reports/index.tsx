        ...
        <div className="flex flex-col gap-4 lg:gap-8">
            <div className="flex justify-between items-center w-full">
                <div 
                    ...
                    lg:gap-0 lg:justify-between lg:items-center w-full"
                >
                    <h1 className="font-coolvetica text-lg lg:text-xl font-bold text-aciu-border-grey">
                        Union Reports & Congress Documents
                    </h1>
                    
                    <div className="flex justify-between md:justify-unset md:gap-4 items-center ">
