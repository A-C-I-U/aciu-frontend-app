...
import { useDuesPayments, useDuesPaymentsVisuals } from "@/services/hooks/transactions"
...
export default function DuesPayment() {
    ...
    const { data: duesPaymentVisual, isLoading: isVisualLoading } = useDuesPaymentsVisuals(selectedYear);
