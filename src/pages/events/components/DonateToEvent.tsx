...
import ThankYouPrompt from "@/pages/projects/components/actions/ThankYouPrompt"
...
import PaymentForm from '@/pages/projects/components/PaymentForm'
...
export default function DonateToEvent({
    open,
    onClose
}: DialogFuncProps) {
    ...
    const handleSubmit = async (values: any, actions: any) => {
        ...
        try {
            const response = await apiClient.post<PaymentIntentResponse>(
                `/payments/payment-intent/event/${eventId}/donate`,
                {
