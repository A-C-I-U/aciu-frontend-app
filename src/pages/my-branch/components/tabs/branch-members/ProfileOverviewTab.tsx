...
export default function ProfileOverviewTab({
    ...
    return (
        <div className="grid md:grid-cols-2 justify-between gap-x-8 gap-y-7.5">
            ...
            <MemberField title="Email Address" content={<span className="flex gap-2 items-center">person@email.com <button><Copy variant="Bold" size={20} color="#00B686" /></button></span>} />
